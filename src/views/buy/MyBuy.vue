                ...
                <el-card shadow="hover" class="mgb20" style="height:130px;">
                    <el-row>
                        <el-col :span="4" style="margin: 5px">
                            <el-input placeholder="订单id" v-model="input" clearable/>
                        </el-col>
                        <el-col :span="4" style="margin: 5px">
                            <el-input placeholder="亚马逊订单id" v-model="input" clearable/>
                        </el-col>
                        <el-col :span="4" style="margin: 5px">
                            <el-input placeholder="关联id" v-model="input" clearable/>
                        </el-col>
                        <el-col :span="4" style="margin: 5px">
                            <el-input placeholder="产品SKU" v-model="input" clearable/>
                        </el-col>
                        <el-col :span="4" style="margin: 5px">
                            <el-input placeholder="产品asin码" v-model="input" clearable/>
                        </el-col>
                        <el-col :span="4" style="margin: 5px">
                            <el-input placeholder="国内物流单号" v-model="input" clearable/>
                        </el-col>
                        <el-col :span="4" style="margin: 5px">
                            <el-input placeholder="国际物流单号" v-model="input" clearable/>
                        </el-col>
                        <el-col :span="4" style="margin: 5px">
                            <el-form-item prop="region">
                                <el-select v-model="form.select_5" placeholder="站点选择">
